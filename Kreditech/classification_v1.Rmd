...
model <- train(binaryclass~., data=train_clean_subset, method="glm", preProcess="scale", trControl=control)
...
model_lm_final = step(lm(binaryclass ~ v19+v12+v34, data = train_clean_subset), direction = "backward", trace=0)
...
print(paste('Accuracy',1-misClasificError_lm_final))
